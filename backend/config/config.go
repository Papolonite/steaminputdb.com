...
type Config struct {
	...
	ListenAddress string  `help:"Server listen address" default:":8888" env:"LISTEN_ADDRESS"`
	CorsOrigins   string  `help:"CORS allowed origins" default:"steaminputdb.com" env:"CORS_ORIGINS"`
